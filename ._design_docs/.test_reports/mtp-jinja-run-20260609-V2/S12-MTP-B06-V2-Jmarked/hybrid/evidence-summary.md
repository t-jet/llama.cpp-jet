...
| Artifact | Path |
| --- | --- |
| baseline.json | D:\source\llama.cpp-jet\._design_docs\.test_reports\mtp-jinja-run-20260609-V2\S12-MTP-B06-V2-Jmarked\hybrid\baseline.json |
| legacy-baseline.json | N/A |
| k6-results.json | D:\source\llama.cpp-jet\._design_docs\.test_reports\mtp-jinja-run-20260609-V2\S12-MTP-B06-V2-Jmarked\hybrid\k6-results.json |
