$url = "http://127.0.0.1:18114/audio/transcriptions"
...
try {
    ...
    $r.Content | Out-File "D:\source\llama.cpp-jet\._design_docs\.test_reports\test-report-20260609-05-artifacts\E13-08-audio-transcriptions-response.json"
} catch {
    ...
    if ($_.Exception.Response) {
        ...
        $body | Out-File "D:\source\llama.cpp-jet\._design_docs\.test_reports\test-report-20260609-05-artifacts\E13-08-audio-transcriptions-body.txt"
    }
}
