...
| [cache-handling-phase6-implementation.md](cache-handling-phase6-implementation.md) | Stage 6 implementation log for cold payload storage and asynchronous I/O. Contains the ordered implementation plan (Parts 1 and 2) covering cold store module creation, atomic write and rename, cold file read and validation, async I/O worker thread, demotion and promotion protocols, hybrid controller integration, startup validation, metrics, test hooks, and fault injection. | Use this to review the Stage 6 implementation plan, approved design baseline reference, store_ref schema compatibility decision, NB-1 through NB-5 resolutions, known risks, and evidence plan before beginning Stage 6 code work. |
